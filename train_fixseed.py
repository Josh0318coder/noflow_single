# python train_fixseed.py --video_data_root_list /media/SSD2/Video_Datasets/DAVIS/davis-dataset-vc/davis_videos,/media/SSD2/Video_Datasets/data-vc-2023-maybex2-final/images/images,/media/SSD2/Video_Datasets/REDS/reds-optflow/reds,/media/SSD2/Video_Datasets/NTIRE/ntire-dataset/ntire_videos --data_root_imagenet /media/SSD2/Video_Datasets/ImageNet/imagenet-vc --annotation_file_path_list /media/SSD2/Video_Datasets/DAVIS/davis-dataset-vc/davis_videos/davis_annot.csv,/media/SSD2/Video_Datasets/data-vc-2023-maybex2-final/images/images/final_annot.csv,/media/SSD2/Video_Datasets/REDS/reds-optflow/reds/reds_annot.csv,/media/SSD2/Video_Datasets/NTIRE/ntire-dataset/ntire_videos/ntire_annot.csv --imagenet_pairs_file /media/SSD2/Video_Datasets/pairs.txt --batch_size 8 --accumulation_steps 1 --epoch 40 --lr 3e-5 --use_augmentation --resume --resume_checkpoint_dir checkpoints/l1_2/epoch_5_latest
...
parser.add_argument("--checkpoint_dir", type=str, default="checkpoints/l1_norm")
...
parser.add_argument("--weight_l1", type=float, default=2.0)
...
def prepare_dataloader_simple(dataset, batch_size=4, pin_memory=False, num_workers=12):
    """簡單的數據載入器，無DDP支持"""
